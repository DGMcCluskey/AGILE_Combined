...
## at this point i need to figure out how to use my gpu to speed up the next steps. clustering take a while, but the model training will take days without it 

```{python}
print(torch.cuda.is_available())  # True if any GPU is available
