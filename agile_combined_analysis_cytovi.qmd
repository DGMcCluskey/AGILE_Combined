...
```{python}
for res in [0.5,0.6,0.7,0.8,0.9,1]:
    sc.tl.leiden(adata, resolution=0.4, key_added="leiden_res_"+str(res), flavor="igraph")
sc.pl.umap(adata, color="leiden_res_0.7", legend_loc="on data")
```
...
cluster_palette= ["green", "limegreen", "red", "darkred", "hotpink", "mediumvioletred", "darkorchid", "mediumpurple", "grey", "goldenrod", "orange", "cyan", "navy", "blue", "deepskyblue", "lightcoral"]
```
...
```{python}
plt.figure()
sc.pl.correlation_matrix(adata, "label", figsize=(20,10))
