...
```{python}
potential_neuts= adata[adata.obs["lediden_CytoVI"].isin(["13","18","16","17","8","12"])].copy()
cytovi.plot_histogram(
    potential_neuts, marker=["CD62L", "CD16"], layer_key="inputed", groupby="leiden_CytoVI", return_plot=True
)
```
```{python}
